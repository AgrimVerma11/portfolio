...
export const skillClusters: SkillCluster[] = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { name: "PyTorch", icon: SiPytorch, level: 0.75, x: 86, y: 7 },
      { name: "ONNX", icon: SiOnnx, level: 0.6, x: 96, y: 18 },
      { name: "NumPy", icon: SiNumpy, level: 0.85, x: 95, y: 36 },
      { name: "Pandas", icon: SiPandas, level: 0.85, x: 85, y: 45 },
  ...
  },
  {
    ...
    color: "#00D4FF",
    nodes: [
      { name: "MongoDB", icon: SiMongodb, level: 0.85, x: 13, y: 58 },
      { name: "InfluxDB", icon: SiInfluxdb, level: 0.6, x: 35, y: 59 },
      { name: "MySQL", icon: SiMysql, level: 0.7, x: 24, y: 82 },
    ],
  },
  {
    category: "Languages",
